...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/issues">Report Bug</a>
    ·
    <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/issues">Request Feature</a>
  </p>
</div>
...
* A <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/blob/main/docker-compose.yml">docker-compose.yml</a> file to startup the basic infrastructure needed to run the services
* A folder for the <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025-productcatalog">ProductCatalog</a> microservice 
* A folder for the <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025-user">User</a> microservice 
* A folder for the <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025-notification">Notification</a> microservice 
...
* Download the code in ZIP format or just clone the <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025">spring2025</a> repository in the working folder (_spring-2025_ if the recommendation has been followed).
...
![Docker containers running](https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/blob/main/docker_containers_running.png)
...
![Adminer productdb 1](https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/blob/main/adminer1.png)

![Adminer productdb 2](https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/blob/main/adminer1_1.png)
...
![Adminer userdb 1](https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/blob/main/adminer2.png)

![Adminer userdb 2](https://github.com/UOC-ISCSD-SPRING-2025/spring-2025/blob/main/adminer2_1.png)


### Microservices stubs

* Download the code in ZIP format or just clone the <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025-productcatalog">spring-2025-productcatalog</a>, <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025-user">spring-2025-user</a> and <a href="https://github.com/UOC-ISCSD-SPRING-2025/spring-2025-notification">spring-2025-notification</a> repositories into the working folder (_spring-2025_ if the recommendation has been followed)
...
Jesús Vazquez - jvazquezfern@uoc.edu
